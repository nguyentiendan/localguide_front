          ...
          <GridItem xs={12} sm={12} md={4}>
            <Wrapper style={{ textAlign: "left"}}>
              <Link to={`/tours/${1}/${2}?status=view`}>
                ...
                <SubTitle>
                  Hanoi: Hanoi, a city of lakes, shaded boulevards and public parks, is the capital of Vietnam. It is a very attractive city with French-style architecture. Take part in the Water Puppet show. Halong Bay: Overnight cruise in a traditional Junk boat, discover caves & fishing villages, explore the lagoon.
                </SubTitle>
              </Link>
            </Wrapper>
          </GridItem>
