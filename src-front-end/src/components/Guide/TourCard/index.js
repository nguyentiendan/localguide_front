  ...
  return (
    <Badge style={{ width: '100%' }}>
      <CardWrapper
        ...
        cover={<WrapperImageCard><Image src={coverImg || backpackers} onClick={() => navigate(`/app/guideTourReview?uid=${uid}&id=${id}`)} /><span className='styled-box-price'><NumberFormat value={price} displayType="text" thousandSeparator prefix="$" /> </span></WrapperImageCard>}
        actions={
          status
            ? [
