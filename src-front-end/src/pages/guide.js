              ...
              <GridItem xs={12} sm={12} md={12}>
                <div className={classes.description}>
                  ...
                  <i>
                    ...
                    Melbourne-raised, Brooklyn-based Nick Murphy — writes, performs and records all
                    of his own music, giving it a warm, intimate feel with a solid groove structure.
                  </i>
                  <FormatQuote style={{ color: '#e91e63' }} />
                </div>
              </GridItem>
            ...
            <GridContainer justify="center">
              <GridItem xs={12} sm={12} md={12}>
                <div className={classes.description}>
                  ...
                  <div
                    style={{ textAlign: 'left', color: '#494848' }}
              ...
              <GridContainer justify="center">
                <GridItem xs={12} sm={12} md={12}>
                  <div className={classes.description}>
                    ...
                    {images?.length > 1 && <ImageGallery items={images} lazyLoad infinite />}
                  </div>
                </GridItem>
              </GridContainer>
            )}
