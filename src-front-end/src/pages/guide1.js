...
function GuideProfile({ location }) {
  ...
  console.log(tour.related.tours.length);
  console.log(tour.related.allTour.length);
  ...
  /*
  //TODO
  1-Add loading Spin - DONE
  2-Add short description for guide - DONE
  3-Add link for Related Tour - DONE
  4-Save Country
  5-Chinh lai Related Tour cho nam ngang - DONE
  */
  console.log(profile);
  return (
