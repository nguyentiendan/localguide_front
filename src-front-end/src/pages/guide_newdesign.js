...
// @material-ui/icons
import { LocationOn, Camera, Palette, Favorite,Language,CardTravel,Star,StarHalf,StarRate} from "@material-ui/icons";
// core components
            ...
            <GridContainer justify="center">
              <GridItem xs={12} sm={12} md={8}>
                <div className={classes.description}>
                  ...
                  <div style={{ textAlign: "left"}} dangerouslySetInnerHTML={{ __html: profile.guide?.experience }} />              
                </div>
              </GridItem>
            </GridContainer>
                  ...
                  {_.map(profile.tours, (tour, index) => (
                    <GridContainer key={index}>
                        <GridItem xs={12} sm={12} md={4}>
                          <img src={tour.cover} alt="..." className={imageClasses_1} style={{ cursor: 'pointer', maxWidth: 200, minWidth: 200, maxHeight: 150, minHeight: 100, borderRadius: 10 }} />                    
                        </GridItem>
